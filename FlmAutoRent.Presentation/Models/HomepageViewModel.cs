...
namespace FlmAutoRent.Presentation.Models
{
    public class HomepageViewModel
    {
        public HomepageViewModel(){
            ...
            NewsOnFooter = new List<GetContentNewsOnFooter>();
        ...
        public List<GetContentNewsOnFooter> NewsOnFooter { get; set; } = new List<GetContentNewsOnFooter>();
    ...
    public class GetContentNewsOnFooter
    {
        public string Permalink { get; set; }
